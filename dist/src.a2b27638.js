...
var store = (0, _redux.legacy_createStore)((0, _redux.combineReducers)(rootReducer));
console.log(store.getState());
var unsubscribe = store.subscribe(function () {
  return console.log("cake & icecream current quatity", store.getState());
});
...
unsubscribe();
},{"./styles.css":"src/styles.css","redux":"node_modules/redux/es/redux.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
