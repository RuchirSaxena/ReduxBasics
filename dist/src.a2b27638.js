...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/@babel/runtime/helpers/esm/typeof.js":[function(require,module,exports) {
"use strict";
...
var RESTOCK_ICECREAM = "RESTOCK_ICECREAM";
...
var cakeReducer = function cakeReducer() {
  ...
  switch (action.type) {
    ...
    case RESTOCK_CAKE:
      var restockQty = 10 - state.noOfCakes;
      return _objectSpread(_objectSpread({}, state), {}, {
...
var iceCreamReducer = function iceCreamReducer() {
  ...
  switch (action.type) {
    ...
    case RESTOCK_ICECREAM:
      var restockQty = 20 - state.noOfIceCream;
      return _objectSpread(_objectSpread({}, state), {}, {
...
var store = (0, _redux.legacy_createStore)((0, _redux.combineReducers)(rootReducer), (0, _redux.applyMiddleware)(logger));
...
unsubscribe();
},{"./styles.css":"src/styles.css","redux":"node_modules/redux/es/redux.js","redux-logger":"node_modules/redux-logger/dist/redux-logger.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
